...
pub const VK_SHADER_MODULE_CREATE_FLAG_BITS_MAX_ENUM: c_int = 2147483647;
pub const enum_VkShaderModuleCreateFlagBits = c_uint;
...
pub const VK_PIPELINE_STAGE_2_TRANSFER_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @as(c_longlong, @as(c_int, 4096)));
...
pub const VK_PIPELINE_STAGE_2_SHADING_RATE_IMAGE_BIT_NV: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @as(c_longlong, @as(c_int, 4194304)));
...
pub const VK_PIPELINE_STAGE_2_RAY_TRACING_SHADER_BIT_NV: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @as(c_longlong, @as(c_int, 2097152)));
pub const VK_PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_BUILD_BIT_NV: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @as(c_longlong, @as(c_int, 33554432)));
...
pub const VK_PIPELINE_STAGE_FLAG_BITS_2KHR_MAX_ENUM_KHR: VkPipelineStageFlagBits2KHR = 9223372036854775807;
...
pub const VK_ACCESS_2_SHADING_RATE_IMAGE_READ_BIT_NV: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @as(c_longlong, @as(c_int, 8388608)));
...
pub const VK_ACCESS_2_ACCELERATION_STRUCTURE_READ_BIT_NV: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @as(c_longlong, @as(c_int, 2097152)));
pub const VK_ACCESS_2_ACCELERATION_STRUCTURE_WRITE_BIT_NV: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @as(c_longlong, @as(c_int, 4194304)));
...
pub const VK_ACCESS_FLAG_BITS_2KHR_MAX_ENUM_KHR: VkAccessFlagBits2KHR = 9223372036854775807;
...
pub const VkAabbPositionsNV = VkAabbPositionsKHR; // C:/VulkanSDK/1.2.176.1/Include\vulkan/vulkan_core.h:10139:35: warning: struct demoted to opaque type - has bitfield
...
pub const offsetof = @compileError("TODO implement function '__builtin_offsetof' in std.c.builtins"); // C:\Users\InK\zig\lib\zig\include\stddef.h:104:9
pub const __stdint_join3 = @compileError("unable to translate C expr: unexpected token .HashHash"); // C:\Users\InK\zig\lib\zig\include\stdint.h:245:9
pub const __int_c_join = @compileError("unable to translate C expr: unexpected token .HashHash"); // C:\Users\InK\zig\lib\zig\include\stdint.h:282:9
pub const __uint_c = @compileError("unable to translate C expr: expected ',' or ')'"); // C:\Users\InK\zig\lib\zig\include\stdint.h:284:9
pub const VK_DEFINE_HANDLE = @compileError("unable to translate C expr: unexpected token .Keyword_typedef"); // C:/VulkanSDK/1.2.176.1/Include\vulkan/vulkan_core.h:25:9
pub const VK_DEFINE_NON_DISPATCHABLE_HANDLE = @compileError("unable to translate C expr: unexpected token .Keyword_typedef"); // C:/VulkanSDK/1.2.176.1/Include\vulkan/vulkan_core.h:55:17
...
pub const VK_NULL_HANDLE = @import("std").zig.c_translation.cast(?*c_void, @as(c_int, 0));
...
pub const VK_HEADER_VERSION = @as(c_int, 176);
